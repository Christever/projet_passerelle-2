...
if (Utils::verifAdmin()){
    ...
    <section class="container d-flex flex-column flex-grow-1">
        <h1 class="text-center text-white mt-5">Ajout d'une recette</h1>
        <div class="form-body bg-primary w-75">
            ...
            ?>
            <form action="verifAddRecipt" class="" method="post" enctype="multipart/form-data">

                <div class="mb-3 input-group">
                    <span class="input-group-text">Nom de la recette</span>
                    <input type="text" class="form-control" id="title" name="title" placeholder="Nom de la recette" required>
                </div>
                <div class="input-group mb-3">
                    <span class="input-group-text">Temps de préparation</span>
                    <input type="time" class="form-control" name="temps" placeholder="Temps necessaire">
                </div>
                ...
                <div class="mb-3">
                    <div class="input-group">
                        <div class="form-floating me-2">
                            <textarea name="ingredients" id="" cols="30" rows="10" class="form-control" style="height: 300px;"></textarea>
                            <label for="ingredient">Ingrédients</label>
                        </div>
                        <div class="form-floating">
                            <textarea name="preparation" id="" cols="30" rows="10" class="form-control" style="height: 300px;"></textarea>
                ...
                <div class="mt-3">
                    <div class="input-group custom-file-button ">
                        <input class="form-control input-group-text" type="file" name="image" required>
