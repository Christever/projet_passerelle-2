                ...
                >
                    <div class="card m-3">
                        ...
                        <div class="card-footer">
                            <button class="btn btn-light w-100 bm"
                                    id="buttonModal"
                                    data-bs-toggle="modal"
                                    data-bs-target="#recipt-modal"
                                    data-blog-id = "<?=$recip['id']?>"
                                    data-blog-title = "<?=$recip['title']?>"
                                    data-blog-preparation = "<?=$recip['preparation']?>"
                                    data-blog-ingredients = "<?=$recip['ingredients']?>"
                                    >En savoir plus
                            </button>
                        </div>
                    </div>
